...
var init = () => {
    ...
    {
        c1Exp = theory.createMilestoneUpgrade(0, 10000);
        c1Exp.description = Localization.getUpgradeIncCustomExpDesc("c_1", "100");
        c1Exp.info = Localization.getUpgradeIncCustomExpInfo("c_1", "100");
        c1Exp.boughtOrRefunded = (_) => theory.invalidatePrimaryEquation();
    }

    {
        c2Exp = theory.createMilestoneUpgrade(1, 2000);
        c2Exp.description = Localization.getUpgradeIncCustomExpDesc("c_2", "100");
        c2Exp.info = Localization.getUpgradeIncCustomExpInfo("c_2", "100");
    ...
    achievement3 = theory.createAchievement(2, "High", "Buy 5 for c1", () => c1.level > 5);
    achievement4 = theory.createAchievement(3, "This Buy!", "Buy 5 for c1", () => c1.level > 5);
